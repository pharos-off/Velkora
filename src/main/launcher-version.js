...
const LauncherVersion = {
  ...
  name: 'Velkora Client',
  version: '4.4.4', // Format: MAJOR.MINOR.PATCH
  versionName: '4.4.4', // Format: Nom de la version
  build: '20260728', // Format: YYYYMMDD
  releaseDate: '2026-07-28', // Format: YYYY-MM-DD
