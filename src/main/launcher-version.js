...
const LauncherVersion = {
  ...
  name: 'Velkora Client',
  version: '4.7.0', // Format: MAJOR.MINOR.PATCH
  versionName: '4.7.0', // Format: Nom de la version
  build: '20260901', // Format: YYYYMMDD
  releaseDate: '2026-09-01', // Format: YYYY-MM-DD
